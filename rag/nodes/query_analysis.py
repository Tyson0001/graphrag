...
from rag.nodes.intent_classifier import IntentClassifier
...
def analyze_query(
    ...
    try:
        ...
        # PS1: Intent detection and query expansion
        detected_intent = _intent_clf.classify(context_query)
        expanded_queries = _intent_clf.expand_query(context_query, detected_intent)
